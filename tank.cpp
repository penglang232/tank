           ...
           QWidget *widget)
{
    ...
    points <<
        QPointF(this->width / 2 - gnuWidth * 2, -gnuWidth) <<
        QPointF(this->width / 2 - gnuWidth, 0) <<
    ...
    painter->drawEllipse(this->width /2 -8,this->height /2 - 4, this->width / 3, this->height /3 - 2);
    painter->drawEllipse(this->width /2 -4,this->height /2, this->width / 6, this->height /6 -2);
